...
public class Main {
    public static void main(String[] args) {
        ...
        int dzien = ktoryDzien(scanner);//wybor dnia
        ArrayList<Spotkanie> dziennik = kalendarz.getSpotkanie(dzien);//dziennik = arraylista majaca arraylisty z danego dnia
        do{
            ...
            menu(scanner,wybor,dzien,dziennik,kalendarz);
        }while (true);
    }
    ...
    public static void menu(Scanner scanner,int wybor,int dzien, ArrayList<Spotkanie> dziennik, Kalendarz kalendarz){
        switch (wybor){
            case 1 -> show(kalendarz,scanner);
            case 2 -> {
                dzien = ktoryDzien(scanner);// potrzebujemy wiedziec do jakiego dnia dodac
